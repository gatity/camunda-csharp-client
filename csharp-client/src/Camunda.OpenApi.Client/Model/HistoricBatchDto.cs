...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricBatchDto : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="endTime">The time the batch ended. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further information, please see the [documentation](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/).</param>
        /// <param name="removalTime">The time after which the historic batch should be removed by the History Cleanup job. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further information, please see the [documentation](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/).</param>
        public HistoricBatchDto(string id = default(string), string type = default(string), int? totalJobs = default(int?), int? batchJobsPerSeed = default(int?), int? invocationsPerBatchJob = default(int?), string seedJobDefinitionId = default(string), string monitorJobDefinitionId = default(string), string batchJobDefinitionId = default(string), string tenantId = default(string), string createUserId = default(string), DateTime? startTime = default(DateTime?), DateTime? executionStartTime = default(DateTime?), DateTime? endTime = default(DateTime?), DateTime? removalTime = default(DateTime?))
        {
            this.Id = id;
            this.Type = type;
        ...
        /// </summary>
        /// <value>The time the batch ended. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further information, please see the [documentation](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/)</value>
        ...
        /// </summary>
        /// <value>The time after which the historic batch should be removed by the History Cleanup job. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further information, please see the [documentation](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/)</value>
