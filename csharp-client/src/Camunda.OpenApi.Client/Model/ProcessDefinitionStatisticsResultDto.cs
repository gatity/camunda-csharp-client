...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class ProcessDefinitionStatisticsResultDto : IValidatableObject
    {
        /// <summary>
        ...
        public ProcessDefinitionStatisticsResultDto(string id = default(string), int instances = default(int), int failedJobs = default(int), List<IncidentStatisticsResultDto> incidents = default(List<IncidentStatisticsResultDto>), string varClass = default(string), ProcessDefinitionDto definition = default(ProcessDefinitionDto))
        {
            this.Id = id;
