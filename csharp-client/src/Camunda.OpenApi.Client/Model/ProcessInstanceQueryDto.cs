...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class ProcessInstanceQueryDto : IValidatableObject
    {
        /// <summary>
        ...
        public List<ProcessInstanceQueryDtoSortingInner> Sorting { get; set; }
