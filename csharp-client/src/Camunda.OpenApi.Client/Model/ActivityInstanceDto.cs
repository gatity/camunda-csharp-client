...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class ActivityInstanceDto : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="name">The name of the activity. This property is deprecated. Please use &#39;activityName&#39;..</param>
        ...
        public ActivityInstanceDto(string id = default(string), string parentActivityInstanceId = default(string), string activityId = default(string), string activityName = default(string), string name = default(string), string activityType = default(string), string processInstanceId = default(string), string processDefinitionId = default(string), List<ActivityInstanceDto> childActivityInstances = default(List<ActivityInstanceDto>), List<TransitionInstanceDto> childTransitionInstances = default(List<TransitionInstanceDto>), List<string> executionIds = default(List<string>), List<string> incidentIds = default(List<string>), List<ActivityInstanceIncidentDto> incidents = default(List<ActivityInstanceIncidentDto>))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>The name of the activity. This property is deprecated. Please use &#39;activityName&#39;.</value>
