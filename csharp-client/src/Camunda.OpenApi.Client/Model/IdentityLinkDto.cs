...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class IdentityLinkDto : IValidatableObject
    {
        /// <summary>
        ...
        public IdentityLinkDto(string userId = default(string), string groupId = default(string), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for IdentityLinkDto and cannot be null");
            }
            this.Type = type;
            this.UserId = userId;
