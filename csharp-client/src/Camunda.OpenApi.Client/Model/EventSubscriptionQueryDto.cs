...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class EventSubscriptionQueryDto : IValidatableObject
    {
        /// <summary>
        ...
        public EventSubscriptionQueryDto(string eventSubscriptionId = default(string), string eventName = default(string), EventTypeEnum? eventType = default(EventTypeEnum?), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), List<string> tenantIdIn = default(List<string>), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), List<EventSubscriptionQueryDtoSortingInner> sorting = default(List<EventSubscriptionQueryDtoSortingInner>))
        {
        ...
        public List<EventSubscriptionQueryDtoSortingInner> Sorting { get; set; }
