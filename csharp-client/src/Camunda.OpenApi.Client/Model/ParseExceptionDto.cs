...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class ParseExceptionDto : IValidatableObject
    {
        /// <summary>
        ...
        public ParseExceptionDto(string type = default(string), string message = default(string), decimal code = default(decimal), Dictionary<string, ResourceReportDto> details = default(Dictionary<string, ResourceReportDto>))
        {
            this.Type = type;
