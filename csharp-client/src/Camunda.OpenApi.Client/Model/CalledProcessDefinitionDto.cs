...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class CalledProcessDefinitionDto : IValidatableObject
    {
        /// <summary>
        ...
        public CalledProcessDefinitionDto(string id = default(string), string key = default(string), string category = default(string), string description = default(string), string name = default(string), int? varVersion = default(int?), string resource = default(string), string deploymentId = default(string), string diagram = default(string), bool? suspended = default(bool?), string tenantId = default(string), string versionTag = default(string), int? historyTimeToLive = default(int?), bool? startableInTasklist = default(bool?), List<string> calledFromActivityIds = default(List<string>), string callingProcessDefinitionId = default(string))
        {
            this.Id = id;
            this.Key = key;
