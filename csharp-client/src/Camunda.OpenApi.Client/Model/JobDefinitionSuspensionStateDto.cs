...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class JobDefinitionSuspensionStateDto : IValidatableObject
    {
        /// <summary>
        ...
        public JobDefinitionSuspensionStateDto(bool? suspended = default(bool?), bool? includeJobs = default(bool?), string executionDate = default(string))
        {
