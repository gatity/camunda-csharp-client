...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricBatchQueryDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricBatchQueryDto" /> class.
        /// </summary>
        /// <param name="batchId">Filter by batch id..</param>
        /// <param name="type">Filter by batch type. See the [User Guide](https://docs.camunda.org/manual/7.21/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types..</param>
        ...
        public HistoricBatchQueryDto(string batchId = default(string), string type = default(string), bool? completed = default(bool?), List<string> tenantIdIn = default(List<string>), bool? withoutTenantId = default(bool?), List<HistoricBatchQueryDtoSortingInner> sorting = default(List<HistoricBatchQueryDtoSortingInner>))
        {
        ...
        /// </summary>
        /// <value>Filter by batch type. See the [User Guide](https://docs.camunda.org/manual/7.21/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types.</value>
        ...
        public List<HistoricBatchQueryDtoSortingInner> Sorting { get; set; }
