...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricIncidentApiSync : IApiAccessor
    {
        ...
        /// <param name="createTimeBefore">Restricts to incidents that have a createTime date before the given date. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="createTimeAfter">Restricts to incidents that have a createTime date after the given date. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="endTimeBefore">Restricts to incidents that have an endTimeBefore date before the given date. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="endTimeAfter">Restricts to incidents that have an endTimeAfter date after the given date. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        ...
        CountResultDto GetHistoricIncidentsCount(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? createTimeBefore = default(DateTime?), DateTime? createTimeAfter = default(DateTime?), DateTime? endTimeBefore = default(DateTime?), DateTime? endTimeAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string historyConfiguration = default(string), bool? open = default(bool?), bool? resolved = default(bool?), bool? deleted = default(bool?), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string jobDefinitionIdIn = default(string));
    ...
    public interface IHistoricIncidentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CountResultDto> GetHistoricIncidentsCountAsync(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? createTimeBefore = default(DateTime?), DateTime? createTimeAfter = default(DateTime?), DateTime? endTimeBefore = default(DateTime?), DateTime? endTimeAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string historyConfiguration = default(string), bool? open = default(bool?), bool? resolved = default(bool?), bool? deleted = default(bool?), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string jobDefinitionIdIn = default(string), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
