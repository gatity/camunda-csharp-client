...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IVariableInstanceApiSync : IApiAccessor
    {
        ...
        CountResultDto GetVariableInstancesCount(string variableName = default(string), string variableNameLike = default(string), string processInstanceIdIn = default(string), string executionIdIn = default(string), string caseInstanceIdIn = default(string), string caseExecutionIdIn = default(string), string taskIdIn = default(string), string batchIdIn = default(string), string activityInstanceIdIn = default(string), string tenantIdIn = default(string), string variableValues = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), string variableScopeIdIn = default(string));
    ...
    public interface IVariableInstanceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<VariableInstanceDto> GetVariableInstanceAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<VariableInstanceDto>> GetVariableInstanceWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Get Variable Instance (Binary)
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<FileParameter> GetVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> GetVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Get Variable Instances
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CountResultDto> GetVariableInstancesCountAsync(string variableName = default(string), string variableNameLike = default(string), string processInstanceIdIn = default(string), string executionIdIn = default(string), string caseInstanceIdIn = default(string), string caseExecutionIdIn = default(string), string taskIdIn = default(string), string batchIdIn = default(string), string activityInstanceIdIn = default(string), string tenantIdIn = default(string), string variableValues = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), string variableScopeIdIn = default(string), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CountResultDto</returns>
        System.Threading.Tasks.Task<CountResultDto> QueryVariableInstancesCountAsync(VariableInstanceQueryDto variableInstanceQueryDto = default(VariableInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<CountResultDto>> QueryVariableInstancesCountWithHttpInfoAsync(VariableInstanceQueryDto variableInstanceQueryDto = default(VariableInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class VariableInstanceApi : IDisposable, IVariableInstanceApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VariableInstanceDto</returns>
        public async System.Threading.Tasks.Task<VariableInstanceDto> GetVariableInstanceAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VariableInstanceDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<VariableInstanceDto>> GetVariableInstanceWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling VariableInstanceApi->GetVariableInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> GetVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<FileParameter>> GetVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling VariableInstanceApi->GetVariableInstanceBinary");
        ...
        /// <summary>
        /// Get Variable Instance Count Query for the number of variable instances that fulfill given parameters. Takes the same parameters as the [Get Variable Instances](https://docs.camunda.org/manual/7.21/reference/rest/variable-instance/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="variableName">Filter by variable instance name. (optional)</param>
        /// <param name="variableNameLike">Filter by the variable instance name. The parameter can include the wildcard &#x60;%&#x60; to express like-strategy such as: starts with (&#x60;%&#x60;name), ends with (name&#x60;%&#x60;) or contains (&#x60;%&#x60;name&#x60;%&#x60;). (optional)</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CountResultDto</returns>
        public async System.Threading.Tasks.Task<CountResultDto> QueryVariableInstancesCountAsync(VariableInstanceQueryDto variableInstanceQueryDto = default(VariableInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
