...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricUserOperationLogApiSync : IApiAccessor
    {
        ...
        /// <param name="operationType">Filter by the type of the operation like &#x60;Claim&#x60; or &#x60;Delegate&#x60;. See the [Javadoc](https://docs.camunda.org/manual/7.21/reference/javadoc/?org/camunda/bpm/engine/history/UserOperationLogEntry.html) for a list of available operation types. (optional)</param>
        ...
        /// <param name="afterTimestamp">Restrict to entries that were created after the given timestamp. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the timestamp must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., 2013-01-23T14:42:45.000+0200. (optional)</param>
        /// <param name="beforeTimestamp">Restrict to entries that were created before the given timestamp. By [default](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/), the timestamp must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., 2013-01-23T14:42:45.000+0200. (optional)</param>
    ...
    public interface IHistoricUserOperationLogApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task ClearAnnotationUserOperationLogAsync(string operationId, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ClearAnnotationUserOperationLogWithHttpInfoAsync(string operationId, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Get User Operation Log Count
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CountResultDto> QueryUserOperationCountAsync(string deploymentId = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processInstanceId = default(string), string executionId = default(string), string caseDefinitionId = default(string), string caseInstanceId = default(string), string caseExecutionId = default(string), string taskId = default(string), string externalTaskId = default(string), string batchId = default(string), string jobId = default(string), string jobDefinitionId = default(string), string userId = default(string), string operationId = default(string), string operationType = default(string), string entityType = default(string), string entityTypeIn = default(string), string category = default(string), string categoryIn = default(string), string property = default(string), DateTime? afterTimestamp = default(DateTime?), DateTime? beforeTimestamp = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task SetAnnotationUserOperationLogAsync(string operationId, AnnotationDto annotationDto = default(AnnotationDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> SetAnnotationUserOperationLogWithHttpInfoAsync(string operationId, AnnotationDto annotationDto = default(AnnotationDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class HistoricUserOperationLogApi : IDisposable, IHistoricUserOperationLogApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ClearAnnotationUserOperationLogAsync(string operationId, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> ClearAnnotationUserOperationLogWithHttpInfoAsync(string operationId, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'operationId' is set
            if (operationId == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'operationId' when calling HistoricUserOperationLogApi->ClearAnnotationUserOperationLog");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SetAnnotationUserOperationLogAsync(string operationId, AnnotationDto annotationDto = default(AnnotationDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> SetAnnotationUserOperationLogWithHttpInfoAsync(string operationId, AnnotationDto annotationDto = default(AnnotationDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'operationId' is set
            if (operationId == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'operationId' when calling HistoricUserOperationLogApi->SetAnnotationUserOperationLog");
