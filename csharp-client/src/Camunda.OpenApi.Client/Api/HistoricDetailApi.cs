...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricDetailApiSync : IApiAccessor
    {
        ...
        /// <param name="occurredBefore">Restrict to historic details that occured before the given date (including the date). Default [format](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., 2013-01-23T14:42:45.000+0200. (optional)</param>
        /// <param name="occurredAfter">Restrict to historic details that occured after the given date (including the date). Default [format](https://docs.camunda.org/manual/7.21/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., 2013-01-23T14:42:45.000+0200. (optional)</param>
    ...
    public interface IHistoricDetailApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CountResultDto> GetHistoricDetailsCountAsync(string processInstanceId = default(string), string processInstanceIdIn = default(string), string executionId = default(string), string taskId = default(string), string activityInstanceId = default(string), string caseInstanceId = default(string), string caseExecutionId = default(string), string variableInstanceId = default(string), string variableTypeIn = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string userOperationId = default(string), bool? formFields = default(bool?), bool? variableUpdates = default(bool?), bool? excludeTaskDetails = default(bool?), bool? initial = default(bool?), DateTime? occurredBefore = default(DateTime?), DateTime? occurredAfter = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<HistoricDetailDto> HistoricDetailAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<HistoricDetailDto>> HistoricDetailWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Get Historic Detail (Binary)
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<FileParameter> HistoricDetailBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> HistoricDetailBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Get Historic Details (POST)
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;HistoricDetailDto&gt;</returns>
        System.Threading.Tasks.Task<List<HistoricDetailDto>> QueryHistoricDetailsAsync(int? firstResult = default(int?), int? maxResults = default(int?), bool? deserializeValues = default(bool?), HistoricDetailQueryDto historicDetailQueryDto = default(HistoricDetailQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;HistoricDetailDto&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<HistoricDetailDto>>> QueryHistoricDetailsWithHttpInfoAsync(int? firstResult = default(int?), int? maxResults = default(int?), bool? deserializeValues = default(bool?), HistoricDetailQueryDto historicDetailQueryDto = default(HistoricDetailQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class HistoricDetailApi : IDisposable, IHistoricDetailApi
    {
        ...
        /// <summary>
        /// Get Historic Details Queries for historic details that fulfill the given parameters. The size of the result set can be retrieved by using the [Get Historic Detail Count](https://docs.camunda.org/manual/7.21/reference/rest/history/detail/get-detail-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="processInstanceId">Filter by process instance id. (optional)</param>
        /// <param name="processInstanceIdIn">Only include historic details which belong to one of the passed comma-separated process instance ids. (optional)</param>
        ...
        /// <summary>
        /// Get Historic Detail Count Queries for the number of historic details that fulfill the given parameters. Takes the same parameters as the [Get Historic Details](https://docs.camunda.org/manual/7.21/reference/rest/history/detail/get-detail-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="processInstanceId">Filter by process instance id. (optional)</param>
        /// <param name="processInstanceIdIn">Only include historic details which belong to one of the passed comma-separated process instance ids. (optional)</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of HistoricDetailDto</returns>
        public async System.Threading.Tasks.Task<HistoricDetailDto> HistoricDetailAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (HistoricDetailDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<HistoricDetailDto>> HistoricDetailWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricDetailApi->HistoricDetail");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> HistoricDetailBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<FileParameter>> HistoricDetailBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricDetailApi->HistoricDetailBinary");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;HistoricDetailDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricDetailDto>>> QueryHistoricDetailsWithHttpInfoAsync(int? firstResult = default(int?), int? maxResults = default(int?), bool? deserializeValues = default(bool?), HistoricDetailQueryDto historicDetailQueryDto = default(HistoricDetailQueryDto), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
